...
const About = () => {
  ...
  return <section id="about" className="py-16 sm:py-20 lg:py-24 px-4 bg-gradient-to-b from-black via-purple-950/20 to-black">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-16">
          ...
          return <Card key={index} className="glass-card border-purple-400/20 hover:border-purple-400/40 transition-all duration-300 hover-lift">
