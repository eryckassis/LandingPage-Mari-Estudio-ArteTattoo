  ...
  const features = [
    {
      ...
      description:
        "Cada tatuagem é única, criada especialmente para você com técnicas avançadas e criatividade sem limites.",
    },
    {
      icon: Heart,
      title: "Paixão pela Arte",
      description:
        "Transformo ideias em arte permanente, criando conexões emocionais através de cada traço e cor.",
    },
    {
      icon: Shield,
      title: "Segurança Total",
      description:
        "Ambiente completamente esterilizado, materiais descartáveis e protocolos rigorosos de higiene.",
    },
    {
      icon: Star,
      title: "Excelência",
      description:
        "criando tatuagens que superam expectativas e contam histórias.",
    },
  ];
  return (
    <section
      id="about"
      className="py-16 sm:py-20 lg:py-24 px-4 bg-gradient-to-b from-black via-purple-950/20 to-black"
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 sm:mb-20">
          ...
          <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Arte, técnica e paixão se encontram para criar experiências únicas
            na sua pele
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="glass-card border-purple-400/20 rounded-2xl p-8 sm:p-10">
              <h4 className="text-2xl sm:text-3xl font-bold text-white mb-6 text-center">
                Minha Missão
              </h4>
              <blockquote className="text-lg text-gray-300 leading-relaxed text-center italic">
                "Transformar pele em tela, ideias em arte permanente. Cada
                tatuagem que crio é uma história única, uma expressão da
                personalidade e dos sonhos de quem confia em mim para eternizar
                momentos especiais."
              </blockquote>
