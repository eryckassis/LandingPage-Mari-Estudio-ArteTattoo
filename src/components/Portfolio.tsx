...
const Portfolio = () => {
  const portfolioItems = [
    {
      ...
      title: "Arte Realista",
      category: "Realismo",
      image: "https://images.unsplash.com/photo-1565058379802-bbe93b2b2a2a?w=500&h=500&fit=crop",
      likes: "2.3K",
      views: "15K"
    },
    {
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1568515045052-f9a854d70bfd?w=500&h=500&fit=crop",
      likes: "3.1K",
      views: "18K"
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1611501275019-9b5cda994e8d?w=500&h=500&fit=crop",
      likes: "1.5K",
      views: "9K"
    },
    {
      ...
      category: "Colorido",
      image: "https://images.unsplash.com/photo-1597149492419-0d900ac2d2eb?w=500&h=500&fit=crop",
      likes: "2.7K",
      views: "16K"
    },
    {
  ...
  return (
    <section id="portfolio" className="py-16 sm:py-20 lg:py-24 px-4 bg-gradient-to-b from-black via-purple-950/10 to-black">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 sm:mb-20">
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white mb-6">
            PORT
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-fuchsia-400 to-violet-400">FÓLIO</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
          {portfolioItems.map((item) => (
            <Card key={item.id} className="glass-card border-purple-400/20 group hover:border-purple-400/50 transition-all duration-500 overflow-hidden hover-lift">
                  ...
                  <div className="relative w-full h-full overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-between p-4 sm:p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                      ...
                      <div className="text-white">
                        ...
                        <p className="text-sm text-purple-300 font-medium">{item.category}</p>
                      </div>
                    </div>
        ...
        <div className="text-center">
          <div className="glass-card border-purple-400/20 rounded-2xl p-8 sm:p-10 max-w-3xl mx-auto">
            ...
            <p className="text-gray-300 mb-6 text-lg leading-relaxed">
              Cada tatuagem é uma jornada única. Vamos conversar sobre suas ideias 
              e transformá-las em arte permanente.
            </p>
